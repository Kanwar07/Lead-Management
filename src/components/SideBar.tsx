...
export default function SideBar() {
  return (
    <section className="flex flex-col justify-between px-6 py-8 border border-x-2 border-t-2 bg-[#ffffff]">
      <div className="flex flex-col items-start gap-4">
        ...
        <button className="flex flex-row items-center gap-4 bg-[#f9f9fe] w-full py-2 rounded-3xl px-4">
      ...
      <div className="flex flex-col">
        ...
        <button className="flex flex-row items-center gap-2 bg-[#fafbfc] border rounded-3xl py-1 px-2 mt-4">
          <Image src={profile} alt="profile" height={35} width={35} />
          <div className="flex flex-col items-start">
            <span className="font-sofia font-[14px] font-normal">John Doe</span>
            <span className="font-sofia font-[12px] font-light pr-2">
              johndoe@gmail.com
            </span>
          </div>
        </button>
